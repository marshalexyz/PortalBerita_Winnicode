...
<body>
    ...
    <div class="container w-5/6 flex flex-warp mx-auto py-5 gap-4">
        <div class="mx-auto p-6 flex flex-col gap-2">
            <div class="mx-auto w-full p-6">
                ...
                <h3 class="font-semibold text-center text-sm mb-5">
                    <a href="{{ route('berita-per-kategori', $beritas->kategori_id) }}"
                        class="text-blue-500 hover:text-blue-600">{{ $beritas->kategori->nama_kategori }}</a>
                    -
    ...
    <span>© 2024 - Agif Ghifari M |
            Magang Mandiri PT.Winnicode Garuda Teknologi. All Rights Reserved.</span>
    </div>
    <!-- END OF FOOTER -->
